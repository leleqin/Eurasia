...
$rs = $conn->query("select * from item where item_name = '典型案例'");
$rs2 = $conn->query("select * from item where item_name = '典型案例'");
            ...
            <div class="row blogu">
                <div class="col-sm-4 col-md-4 ">
                    <div class="blog-thumb">
                        <a href="<?php echo "caseCategories.php?title=".$var2 ?>">
                ...
                <div class="col-sm-8 col-md-8">
                    <h2 class="blog-title">
                        <a href="<?php echo "caseCategories.php?title=".$var2 ?>"><?php echo $row['item_title']?></a>
                    </h2>
            ...
            <div class="blog-sidebar">
                ...
                <ul class="sidebar-list">
                    ...
                    while ($row2 = mysqli_fetch_assoc($rs2)){
                        $var = $row2['item_title'];
                    ?>
                    <li><a href="<?php echo "caseCategories.php?title=".$var ?>"><?php echo $row2['item_title']?></a></li>
                        <?php
                        }
                        ?>
                </ul>
