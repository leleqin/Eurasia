...
$title = $_GET['title'];
$rs = $conn->query("select * from item where item_name = '资讯' AND item_title = '$title'");
		...
		<footer id="footer">
			<div class="container">
				<div class="row myfooter">
					...
					© Eurasia University 2018 | <a href="#">Privacy Policy</a> | <a href="#">Terms of Use</a>
					</div></div>
					<div class="col-sm-6">
