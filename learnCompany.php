...
$rs = $conn->query("select * from item where item_name = '产学合作'");
$rs2 = $conn->query("select * from item where item_name = '产学合作'");
            ...
            <div class="row blogu">
                <div class="col-sm-4 col-md-4 ">
                    <div class="blog-thumb">
                        <a href="<?php echo "learnCategories.php?title=".$var2 ?>">
                ...
                <div class="col-sm-8 col-md-8">
                    <h2 class="blog-title">
                        <a href="<?php echo "learnCategories.php?title=".$var2 ?>"><?php echo $row['item_title']?></a>
                    </h2>
        ...
        <aside class="col-md-4 sidebar-padding">
            ...
            <div class="blog-sidebar">
                ...
                <ul class="sidebar-list">
                    <li><a href="learnCompany.php">目录</a></li>
                    <?php
                    while ($row2 = mysqli_fetch_assoc($rs2)){
                        $var = $row2['item_title'];
                    ?>
                    <li><a href="<?php echo "learnCategories.php?title=".$var ?>"><?php echo $row2['item_title']?></a></li>
                        <?php
                        }
                        ?>
                </ul>
            ...
            <div class="blog-sidebar">
                ...
                ?>
                <div class="media">
                    <a class="pull-left" href="#" style="width: 140px;height: 140px">
